package ru.reshetova.reshetova_task8_;
...
public class GoController {
    ...
    void GoButtonOnAction(ActionEvent event) {
        ...
        switch (hundreds) {
            ...
            case 5: text += "пятьсот "; break;
            case 6: text += "шестьсот "; break;
            case 7: text += "семьсот "; break;
            case 8: text += "восемьсот "; break;
            case 9: text += "девятьсот "; break;
        }
        if (tens == 1) { 
            switch (units) {
                case 0: text += "десять"; break;
                case 1: text += "одиннадцать"; break;
                case 2: text += "двенадцать"; break;
                case 3: text += "тринадцать"; break;
                case 4: text += "четырнадцать"; break;
                case 5: text += "пятнадцать"; break;
                case 6: text += "шестнадцать"; break;
                case 7: text += "семнадцать"; break;
                case 8: text += "восемнадцать"; break;
                case 9: text += "девятнадцать"; break;
            }
        } else {
            switch (tens) {
                ...
                case 6: text += "шестьдесят "; break;
                case 7: text += "семьдесят "; break;
                case 8: text += "восемьдесят "; break;
                case 9: text += "девяносто "; break;
            }
            switch (units) {
